...
class GingerBlastScreen extends StatelessWidget {
  const GingerBlastScreen({super.key});

  @override
  Widget build(BuildContext context) {
    String beer_descrption =
        " Ryders Gonger Blast Beer is a beer brand produced by the Ryder's Sports Club & Brewery, which is a microbrewery located in Sri Lanka, and it is brewed using natural apple extracts.Ryders Ginger blast Beer is a relatively new beer brand in Sri Lanka like Wild Apple beer, but it has gained popularity among beer enthusiasts who enjoy trying unique and flavorful beers. It is available at select bars and restaurants in Sri Lanka, and it can also be purchased directly from the Ryder's Sports Club & Brewery.";
        ...
        children: [
          Center(
            child: Container(
              ...
              width: 80.w,
              child:
                  Image.asset('assets/GingerBlast.png', fit: BoxFit.fitHeight),
            ),
          ),
          SizedBox(
            height: 2.h,
