...
class FrankingScreen extends StatelessWidget {
  const FrankingScreen({super.key});

  @override
  Widget build(BuildContext context) {
    String beer_descrption =
        "The Franklin Brandy is an award winning blend of brandies ages in oak caskets with a hint of Armagnac.Brandy can be enjoyed on its own or used as an ingredient in cocktails such as the Sidecar or Brandy Alexander. It is also commonly used in cooking, particularly in desserts such as flambeed fruit or brandy butter.";
        ...
        children: [
          Center(
            child: Container(
              height: 45.h,
              width: 80.w,
              child: Image.asset('assets/frankin1.png', fit: BoxFit.fitHeight),
            ),
          ),
          SizedBox(
            height: 2.h,
