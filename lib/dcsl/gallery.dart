...
class GalerieScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String beer_descrption =
        "Premium aged finest French Brandy combined with fine premium spirits in vats to enhance and give its elegance.Brandy is a type of distilled spirit made from fermented fruit juice.which give it a distinctive flavor and color. Brandy is often enjoyed as a sipping spirit, but it is also commonly used in cocktails and as a cooking ingredient.";
